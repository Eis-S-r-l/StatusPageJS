    ...
    {!result.available ? <Unavailable message={result.message} /> : <>
      <div className={styles.two}>
        <section className={styles.panel}><h2>Add category</h2><form action={createCategory} className={styles.form}>
          <label className={styles.field}>Slug<input name="slug" required placeholder="platform" /></label><label className={styles.field}>Display order<input name="displayOrder" type="number" min="0" defaultValue="0" /></label>
          <label className={styles.field}>English name<input name="nameEn" required /></label><label className={styles.field}>Italian name<input name="nameIt" required /></label><button className={`${styles.button} ${styles.full}`}>Add category</button>
        </form></section>
      ...
      <section className={styles.panel}><h2>Add service</h2><form action={createService} className={styles.form}>
        ...
        <label className={styles.field}>Slug<input name="slug" required placeholder="customer-portal" /></label><label className={styles.field}>English name<input name="nameEn" required /></label><label className={styles.field}>Italian name<input name="nameIt" required /></label>
        ...
        <label className={styles.field}>Monitoring started (UTC)<input name="monitoringStartedAt" type="datetime-local" required /></label><label className={styles.field}>Display order<input name="displayOrder" type="number" min="0" defaultValue="0" /></label><button className={`${styles.button} ${styles.full}`}>Add service</button>
      </form></section>
