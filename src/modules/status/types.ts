...
export interface PublicStatusSnapshot { overallState: ServiceState; lastUpdatedAt: string; uptimeIntervalDays: number; maintenancePreviewDays: number; categories: ServiceCategory[]; activeIncidents: StatusEvent[]; upcomingMaintenance: StatusEvent[]; recentEvents: StatusEvent[]; }
